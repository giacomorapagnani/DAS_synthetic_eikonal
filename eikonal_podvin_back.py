...
vel_mat= vel_grid_1D(xoff.size,zoff.size,vs,layer,spacing)                      #CHANGE V-P OR V-S
...
############1D VEL
#vel=np.array    ((2000.,3500.,6000.)) #dim(vel) != dim(depth)-1
#depth=np.array  ((0.,1000.,1700.,3000.)) #max depth != zmax
...
#vel_mod_ball(vel_mat,200,400,100,vel_ball)
############constant VEL + cube
...
#SOURCE POSITION
sz=2437. #borders != xoff
sx=1000. #borders != zoff
...
np.save('tt_forge_vs_1_2',tt_mat)
np.save('wavefront_forge_vs_1_2',wave_front)
